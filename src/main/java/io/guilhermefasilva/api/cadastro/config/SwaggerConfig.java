...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				.title("API simples para cadastro de clientes e endereços")
				.description("Um exemplo de aplicação a titulo de conhecimento e desenvolvimento utilizando SpringBoot")
				.version("0.0.1")
